...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs_nand=setenv bootargs ${bootargs} noinitrd "     \
			"ubi.mtd=2 root=ubi0:rootfs rootfstype=ubifs rootwait rw "                \
		"mtdparts=gpmi-nand:16m(boot),16m(kernel),128m(rootfs)\0"\
		"bootcmd_nand=run bootargs_base bootargs_nand; nand read ${loadaddr} 0x1000000 0x400000;bootm\0"	\
...
#define CONFIG_SYS_PROMPT		"MX6Q ZEUS-NAND U-Boot > "
